(function ($) {
  ...
  $.extend(SimpleLightbox.prototype, {
    ...
    init: function () {
      ...
      if (this.options.$items) {
        ...
        this.options.bindToItems &&
          this.$items.on("click" + this.ens, function (e) {
            e.preventDefault();
    ...
    setImageDimensions: function () {
      this.$currentImage &&
        this.$currentImage.css("max-height", $window.height() + "px");
    },
    ...
    setupLightboxEvents: function () {
      ...
      if (!this.lightboxEventsSetuped) {
        this.$el.on("click" + this.ens, function (e) {
          ...
          if (
            $target.is(".slbCloseBtn") ||
            (self.options.closeOnOverlayClick && $target.is(".slbWrap"))
          ) {
            self.close();
